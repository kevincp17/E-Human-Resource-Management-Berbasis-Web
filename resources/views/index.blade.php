...
<div class="text-center" style="margin-top: 100px;">
    ...
    @if(Session::get('exist') && Session::get('role')=='Job Applicant')
        <h1>Jumlah lamaran yang berhasil diterima: {{ Session::get('accept_lamaran') }}</h1>
        <h1>Jumlah lamaran yang masih menunggu jawaban: {{ Session::get('wait_lamaran') }}</h1>
    @endif

    @if(Session::get('exist') && Session::get('role')=='company')
{{--        <h1>Jumlah lamaran yang baru masuk: {{ Session::get('lamaran_masuk') }}</h1>--}}

        <h1>Jumlah wawancara yang batal: {{ Session::get('batal_wawancara') }}</h1>
    @endif

</div>
{{--@else--}}
{{--    <div class="p-3 text-center">--}}
{{--        <h1>Selamat datang,pelamar kerja</h1>--}}
{{--        <h1>Silahkan Login/Registrasi untuk melamar pekerjaan</h1>--}}
