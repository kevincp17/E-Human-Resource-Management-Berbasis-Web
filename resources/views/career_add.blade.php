...
<h1 align="center">Tambah Lowongan Baru</h1>
<div id="container" >
    <form  id="addjobForm" action="{{url('/add_career')}}" method="post" class="col-lg-6 offset-lg-3 " enctype="multipart/form-data">
        <fieldset style="background-color:deepskyblue;" class="rounded p-2">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="namPej" name="namLow">
            </div>
            ...
            <div class="form-group">
                <div>
                    ...
                    <select name="type" class="form-control">
                        <option selected>--Pilih Tipe Pegawai--</option>
            ...
            <div class="form-group">
                <div>
                    ...
                    <select name="postion" class="form-control">
                        <option selected>--Pilih Tingkat Posisi--</option>
            ...
            <div class="form-group">
                ...
                <select name="exp" class="form-control">
                    <option selected>--Minimal Pengalaman Kerja--</option>
            ...
            <div class="form-group">
                ...
                <select name="education" class="form-control">
                    <option selected>--Pilih Riwayat Pendidikan--</option>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <input class="form-control" type="number" id="gaji_low" name="gaji_low" min="1800000" placeholder="Min">
                    </div>
                    <div>
                        <h4>~</h4>
                    </div>
                    <div class="col-md-3">
                        <input class="form-control" type="number" id="gaji_high" name="gaji_high" placeholder="Max">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="4" cols="50" name="desk" placeholder="Masukkan deskripsi pekerjaan" form="addjobForm"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="4" cols="50" name="benefits" placeholder="Masukkan tunjangan perusahaan"></textarea>
            </div>

{{--            <div class="form-group ">--}}
{{--                <label class="text-black font-weight-bold" for="gaji">Logo Perusahaan:</label>--}}
{{--                <input type="file" name="logo" class="form-control">--}}
{{--            </div>--}}

            <button type="submit" id="submit_check" class="btn btn-primary btn-lg btn-block"><span class="fas fa-paper-plane"></span>Kirim</button>
        </fieldset>
    </form>
