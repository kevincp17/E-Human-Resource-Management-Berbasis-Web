...
<a class="btn btn-primary mr-md-3 mt-2" href="/applied_job"><span class="fas fa-arrow-left"></span>Kembali ke halaman sebelumnya</a>




<div class="p-3 border m-2 bg-light text-center">
    <form action="{{ url('/accept_job') }}" method="post" class="col-lg-6 offset-lg-3 mt-2 form-horizontal">
        <fieldset style="background-color:deepskyblue;" class="rounded p-2">
        {{ csrf_field() }}
            <div class="form-group">
                    <label class="text-black font-weight-bold" for="example-datepicker">Tentukan Tanggal Wawancara:</label>
                    <input class="form-control" name="tawan" placeholder="MM/DD/YYY" type="datetime-local"/>
            </div>

            <div class="form-group">
                <label class="text-black font-weight-bold" for="example-datepicker">Masukkan Link Zoom:</label>
                <input class="form-control" name="link" placeholder="Link Zoom"/>
            </div>
